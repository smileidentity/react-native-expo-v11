...
/**
 * Enhanced Smart Selfie Enrolment View using ExpoView
 **/
class SmileIDSmartSelfieEnrollmentEnhancedView(context: Context, appContext: AppContext) :
    ...
    override fun Content() {
        EnhancedSmartSelfieEnrollmentView(
            props = props.value,
            onResult = { result ->
                onResult(
                    mapOf(
